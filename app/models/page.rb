...
#  named_scope_with_exact_match :with_parent, :parent_id
  ...
  # end
  #
  %w(can_have_children can_have_comments visitable allowed_child_types archive show_in_nav page_type_package admin_template public_template extra_path_params page_layout).each do |method_name|
      Page.class_eval <<-EOS
